...
QT_MOC_LITERAL(5, 63, 20) // "on_input_textChanged"

    },
    "clientDialog\0sendsignal\0\0on_pushButton_clicked\0"
    "on_send_clicked\0on_input_textChanged"
};
...
void clientDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (clientDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&clientDialog::sendsignal)) {
                *result = 0;
                return;
            }
        }
